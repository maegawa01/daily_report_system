...
public class TasksCreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (_token != null && _token.equals(request.getSession().getId())) {
            ...
            Timestamp task_limitdate = new Timestamp(System.currentTimeMillis());
            String rd_str = request.getParameter("task_limitdate");
            if(rd_str != null && !rd_str.equals("")) {
                task_limitdate = Timestamp.valueOf(request.getParameter("task_limitdate"));
            }
            r.setLimitdate(task_limitdate);
